...
export default function StatisticsItem({
  ...
  return (
    <li className="flex flex-col items-center justify-center w-[47.4%] tab:w-[23.68%] px-3 lg:px-[40px] py-10 lg:py-[66px] text-black text-center bg-statisticsGradient rounded-[8px]">
