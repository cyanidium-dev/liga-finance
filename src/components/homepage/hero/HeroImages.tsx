...
export default function HeroImages() {
  return (
    <>
      ...
      />
      <div className="absolute -z-20 right-[63px] bottom-[-331px] size-[801px] bg-main blur-[180px] supports-[backdrop-filter]:blur-[180px] will-change-transform"></div>
      <Image
      ...
      />
      <div className="tab:hidden absolute bottom-0 right-0 z-[-5] size-[320px] bg-main blur-[100px] supports-[backdrop-filter]:blur-[100px] will-change-transform"></div>
    </>
  );
}
