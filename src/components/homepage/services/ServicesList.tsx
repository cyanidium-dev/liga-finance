...
export default function ServicesList({ servicesList }: ServicesListProps) {
  return (
    <ul className="flex flex-col items-center w-[90%] max-w-[340px] tabxl:max-w-[380px] xl:max-w-[430px] h-[321px] xl:h-[492px] p-7 xl:p-[44px] mx-auto tabxl:mx-0 bg-white rounded-[8px]">
